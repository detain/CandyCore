...
Last commit:      `1c5ed14ea` - "plan: P6.S4 worklog entry, step briefs on disk, two stale plan cites" - over the P6.S4 merge `60891407232a5eb6aad4dab829ec6b2b9e8fee14` - "sugar-crush: P6.S4 config surface for rules - the disabledRules key (Phase 6, step 4 of 7)" - over `03c584c2a` (the P6.S4 resume rewrite) and `a5e34be9b` / `de740f130`. THIS resume rewrite sits on top. Re-derive: git -C /home/sites/sugarcraft log --oneline -1
